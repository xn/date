...
class TestSH < Test::Unit::TestCase
  ...
  def test_broadcast
    ...
    assert_equal([2001, 2, 3], [d.bwyear, d.bweek, d.bwday])
    d = Date.broadcast(2005, 2, 3)
    assert_equal([2005, 1, 3], [d.cwyear, d.cweek, d.cwday])
    ...
    assert_equal([2001, 51, 5], [d.bwyear, d.bweek, d.bwday])
    d = Date.broadcast(2005, -2, -3)
    assert_equal([2005, 52, 5], [d.cwyear, d.cweek, d.cwday])
    ...
    assert_equal([2001, 2, 3, 20, 55, 54, Rational(-9, 24)],
         [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = DateTime.broadcast(2005, 5, 6)
    assert_equal([2005, 1, 29, 0, 0, 0, 0],
         [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
  end
  ...
  def test_canon24oc
    ...
    assert_equal([2001, 2, 3, 0, 0, 0, 0],
         [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = DateTime.broadcast(2005,5,5,24)
    assert_equal([2005, 1, 29, 0, 0, 0, 0],
         [d.year, d.mon, d.mday, d.hour, d.min, d.sec, d.offset])
    d = DateTime.broadcast(2001,5,5,24)
    assert_equal([2001, 2, 3, 0, 0, 0, 0],
